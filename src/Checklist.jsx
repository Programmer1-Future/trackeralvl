...
const topicsMaths = {
  ...
  Statistics: {
    "Data Collection": [
      "Population vs sample — definitions; use a sample to make informal inferences about a population",
      "Simple random sampling — every member has equal chance of selection",
      "Opportunity sampling — use readily available subjects; understand its limitations",
      "Select or critique a sampling technique in context",
      "Understand that different samples can lead to different conclusions about a population",
    ],
    "Data Representation": [
    ...
    "Correlation & Regression": [
      ...
      "Interpret value of r — strength and direction of linear correlation",
      "Regression line y on x — y = a + bx",
      "Interpret gradient and intercept of regression line in context",
